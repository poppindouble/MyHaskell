...
getLibDir = catchIO (getEnv "man_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "man_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "man_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "man_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "man_sysconfdir") (\_ -> return sysconfdir)
